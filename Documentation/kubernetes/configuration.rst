...
``CILIUM_CUSTOM_CNI_CONF`` environment variable to avoid overwriting the configuration file by adding the following to the ``env:`` section of the ``cilium`` DaemonSet:
